...
INSERT INTO `auditoria_productos` VALUES (1,5,'stock','29','28','root@%','2026-07-23 02:14:08'),(2,18,'stock','47','46','root@%','2026-07-23 02:14:08'),(3,27,'stock','106','105','root@%','2026-07-23 02:14:08'),(4,10,'stock','120','118','root@%','2026-07-23 02:19:00'),(5,25,'stock','118','117','root@%','2026-07-23 02:19:00'),(6,10,'stock','118','138','root@%','2026-07-23 02:19:02'),(7,25,'stock','117','127','root@%','2026-07-23 02:19:02');
...
CREATE TABLE `auditoria_stock` (
  ...
  PRIMARY KEY (`auditoria_id`),
  KEY `producto_id` (`producto_id`),
  CONSTRAINT `auditoria_stock_ibfk_1` FOREIGN KEY (`producto_id`) REFERENCES `productos` (`producto_id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `auditoria_stock` VALUES (1,5,29,28,'2026-07-23 02:14:08'),(2,18,47,46,'2026-07-23 02:14:08'),(3,27,106,105,'2026-07-23 02:14:08'),(4,10,120,118,'2026-07-23 02:19:00'),(5,25,118,117,'2026-07-23 02:19:00'),(6,10,118,138,'2026-07-23 02:19:02'),(7,25,117,127,'2026-07-23 02:19:02');
...
-- Dump completed on 2026-07-22 21:24:54
